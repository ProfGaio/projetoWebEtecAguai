...
const getToken = (req) =>{
    ...
    // quando encontrar como separador um espaço. Por fim, considera apenas a segunda parte
    // um array começa na posição [0], então [1] é o segundo elemento de um array.
